            ...
            children: [
              ...
              Align(
                ...
                child: FlutterFlowRadioButton(
                  options: [
                    'La escuela es indispensable para triunfar y adquirir conocimientos esenciales para ejercer una profesión. ',
                    'La escuela es necesaria; en ella se aprenden métodos y reglas que después son útiles para organizarse en la vida. ',
                    'La escuela nos enseña a vivir en sociedad, a comunicarnos y a trabajar en grupo. Es útil para adaptarse a la vida. ',
                    'En la escuela se encuentran ideas y pistas para soñar e imaginar. Esto da ganas de saber más, de leer e investigar, de viajar… pero no de trabajar para tener una profesión. '
                  ].toList(),
